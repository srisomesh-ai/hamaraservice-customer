              ...
              children: [
                ...
                Row(children: [
                  ...
                  RichText(text: const TextSpan(children: [
                    TextSpan(text: 'Hamara', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: Colors.white)),
                    TextSpan(text: 'Service', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: AppColors.brand)),
                  ])),
                ]),
                const SizedBox(height: 48),
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _otpSent ? 'OTP sent to +91 ${_phoneCtrl.text}' : 'Login with your mobile number',
                        style: const TextStyle(fontSize: 14, color: AppColors.muted),
                      ),
                      const SizedBox(height: 28),
                      if (!_otpSent) ...[
                        const Text('Mobile Number', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.ink2)),
                        ...
                        Center(
                          child: Pinput(
                            ...
                            defaultPinTheme: PinTheme(
                              width: 48, height: 52,
                              textStyle: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.ink),
                              decoration: BoxDecoration(
                        ...
                        Center(
                          child: TextButton(
                            ...
                            child: const Text('Change number', style: TextStyle(color: AppColors.teal, fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ],
                      if (_error.isNotEmpty) ...[
                        ...
                        Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(child: Text(_error, style: const TextStyle(fontSize: 13, color: Color(0xFFE53E3E)))),
                          ]),
                        ),
                      ],
